...
Mill.numobs(a::KBEntry) = length(a.ii)
...
########
#   We do not do reduce, as it is potentially very dangerous as it might be desynchronized with the knowledge base
########
...
_numobs(a::AbstractMillNode) = Mill.numobs(a)
